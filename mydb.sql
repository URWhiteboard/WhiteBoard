...
--
-- Host: localhost:3306
-- Generation Time: Nov 09, 2014 at 02:31 AM
...
--
-- Table structure for table `assignmentGradingPolicies`
--

CREATE TABLE `assignmentGradingPolicies` (
`assignmentGradingPolicyID` int(10) unsigned NOT NULL,
  `assignmentID` int(10) unsigned NOT NULL,
  `maxScore` smallint(6) NOT NULL
...
--
-- Indexes for table `assignmentGradingPolicies`
--
ALTER TABLE `assignmentGradingPolicies`
 ADD PRIMARY KEY (`assignmentGradingPolicyID`), ADD UNIQUE KEY `assignmentGradingPolicyID_UNIQUE` (`assignmentGradingPolicyID`), ADD UNIQUE KEY `assignmentID_UNIQUE` (`assignmentID`);

--
-- Indexes for table `assignments`
--
ALTER TABLE `assignments`
 ADD PRIMARY KEY (`assignmentID`,`assignmentGradingPolicyID`,`creatorID`,`latePolicyID`,`fileID`), ADD KEY `fk_assignments_assignmentGradingPolicies1_idx` (`assignmentGradingPolicyID`), ADD KEY `fk_assignments_users1_idx` (`creatorID`), ADD KEY `fk_assignments_latePolicies1_idx` (`latePolicyID`), ADD KEY `fk_assignments_files1_idx` (`fileID`);
...
--
-- AUTO_INCREMENT for table `assignmentGradingPolicies`
--
ALTER TABLE `assignmentGradingPolicies`
MODIFY `assignmentGradingPolicyID` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `assignments`
--
ALTER TABLE `assignments`
MODIFY `assignmentID` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `latePolicies`
MODIFY `latePolicyID` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `letterScales`
--
ALTER TABLE `letterScales`
MODIFY `letterScaleID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `sectionAssignments`
--
ALTER TABLE `sectionAssignments`
MODIFY `sectionAssignmentsID` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `sectionStudents`
MODIFY `sectionStudentID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `sectionTeachers`
MODIFY `sectionTeacherID` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `assignments`
ADD CONSTRAINT `fk_assignments_assignmentGradingPolicies1` FOREIGN KEY (`assignmentGradingPolicyID`) REFERENCES `assignmentGradingPolicies` (`assignmentGradingPolicyID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_assignments_files1` FOREIGN KEY (`fileID`) REFERENCES `files` (`fileID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
