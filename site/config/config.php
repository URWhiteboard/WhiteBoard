...
define("COOKIE_SECRET_KEY", "FXLZH$@Q*xqo]{W2yZamb}wVd");
 ...
 */
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://mail.jacobroschen.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "admin@jacobroschen.com");
define("EMAIL_SMTP_PASSWORD", "yNc-Krg-y7x-ham");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://". $_SERVER['SERVER_NAME'] ."/password_reset/");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://". $_SERVER['SERVER_NAME'] ."/register/");
